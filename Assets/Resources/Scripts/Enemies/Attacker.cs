...
public class Attacker : MonoBehaviour, IEnemy
{
    ...
    public void Die()
    {
        ...
        if (enemyManager.Row0.Contains(gameObject))
        {
            enemyManager.Row0.Remove(gameObject);
        }
        else if (enemyManager.Row1.Contains(gameObject))
        {
            enemyManager.Row1.Remove(gameObject);
        }
