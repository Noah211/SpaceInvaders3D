...
public class Hornet : MonoBehaviour, IEnemy
{
    ...
    public void Die()
    {
        ...
        // To Do: Cleanup, shouldn't need to know about rows
        if (enemyManager.Row2.Contains(gameObject))
        {
            enemyManager.Row2.Remove(gameObject);
        }
        else if (enemyManager.Row3.Contains(gameObject))
        {
            enemyManager.Row3.Remove(gameObject);
        }
